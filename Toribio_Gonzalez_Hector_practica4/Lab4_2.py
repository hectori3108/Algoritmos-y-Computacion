...
#ALGORITMO Aestrella
def Aestrella(V, E, salida, llegada, col):

    #INICIALIZAMOS DICCIONARIO DE DISTANCIAS, DICCIOANRIO DE PADRES, ARRAY EN EL QUE GUARDAMOS EL CAMINO Y LA COLA
    D = {}
    D[salida.compNum()] = 0
    padre = {}
    comprueba = []
    ...
    while cola:
        ...
        for hijos in options:
            if hijos.getPeso() + D[distancia_min]< D[hijos.getNodo().compNum()]:
                ...
                #SUMAMOS LA DISTANCIA DE MANHATTAN
...
timeIn = time.time()
camino, distancias = Aestrella(V, E, salida, destino, c)
timedes = time.time()
#FIN DEL DIJKSTRA
